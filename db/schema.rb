...
ActiveRecord::Schema.define(version: 20_220_620_152_239) do
  ...
  create_table 'cities', force: :cascade do |t|
    ...
    t.datetime 'last_export_time', default: '1970-01-01 00:00:00'
  ...
  create_table 'rails_admin_histories', id: :serial, force: :cascade do |t|
    ...
    t.index %w[item table month year], name: 'index_rails_admin_histories'
  end
  ...
  create_table 'things', id: :serial, force: :cascade do |t|
    ...
    t.index %w[city_id city_domain], name: 'things_by_city_id_and_domain', unique: true
  ...
  create_table 'users', id: :serial, force: :cascade do |t|
    ...
    t.string 'last_name'
    t.string 'city_domain'
    t.index %w[email city_domain], name: 'users_by_email_and_city_domain', unique: true
